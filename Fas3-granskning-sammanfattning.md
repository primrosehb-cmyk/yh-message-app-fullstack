...
Uppdatera jsonwebtoken till version 9.0.0
Lägg till rate limiting med express-rate-limit på /login och /register
Lägg till authenticateUser på DELETE-routen
